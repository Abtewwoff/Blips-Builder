---@type table
local Colour = {
    Background = { Dictionary = "kikizizinazi", Texture = "gradient_bgd", Y = 4, Width = 444, Height = 112 },
    LeftArrow = { Dictionary = "kikizizinazi", Texture = "arrowleft", X = 7.5, Y = 15, Width = 20, Height = 20 },
    RightArrow = { Dictionary = "kikizizinazi", Texture = "arrowright", X = 406.5, Y = 15, Width = 20, Height = 20 },
    Header = { X = 228.5, Y = 15, Scale = 0.26 },
    Box = { X = 38, Y = 57, Width = 41.5, Height = 39.5 },
    SelectedRectangle = { X = 38, Y = 52, Width = 41.5, Height = 3 },
    Seperator = { Text = "of" }
}
...
function RageUI.ColourPanel(Title, Colours, MinimumIndex, CurrentIndex, Action, Index, Style)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Index == Index) then
            ...
            RenderSprite(Colour.Background.Dictionary, Colour.Background.Texture, CurrentMenu.X, CurrentMenu.Y + Colour.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Colour.Background.Width + CurrentMenu.WidthOffset, 3)
            ...
            RenderText((Title and Title or "") --[[.. " (" .. CurrentIndex .. " " .. ColourSeperator.Text .. " " .. #Colours .. ")"]], CurrentMenu.X + RageUI.Settings.Panels.Grid.Text.Top.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUI.Settings.Panels.Grid.Text.Top.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 4, RageUI.Settings.Panels.Grid.Text.Top.Scale, 245, 245, 245, 255, 1)
