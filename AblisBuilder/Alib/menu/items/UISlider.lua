...
local SettingsButton = {
    ...
    RightBadge = { X = 425, Y = -2, Width = 40, Height = 40 },
...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "kikizizinazitu", Texture = "arrowleft", X = 217, Y = 11.5, Width = 10, Height = 10 },
    RightArrow = { Dictionary = "kikizizinazitu", Texture = "arrowright", X = 362, Y = 11.5, Width = 10, Height = 10 },
}
