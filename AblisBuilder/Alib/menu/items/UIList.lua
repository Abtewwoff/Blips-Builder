...
local SettingsButton = {
    ...
    RightBadge = { X = 397, Y = -2, Width = 40, Height = 40 },
    RightText = { X = 432, Y = 4, Scale = 0.26  },
    SelectedSprite = { Dictionary = "kikizizinazi", Texture = "gradient_nav", Y = 0, Width = 444, Height = 35 },
}

---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "kikizizinazi", Texture = "arrowleft", X = 398, Y = 3, Width = 25, Height = 25 },
    RightArrow = { Dictionary = "kikizizinazi", Texture = "arrowright", X = 420, Y = 3, Width = 25, Height = 25 },
    Text = { X = 423, Y = 3, Scale = 0.26 },
}
